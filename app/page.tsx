    ...
    <div className={`bg-black min-h-screen text-white flex flex-col ${inter.className}`}>
      ...
      <main className="container mx-auto px-4 mt-20">
        ...
        <motion.div 
          ...
          style={{ marginTop: '120px', marginBottom: '120px' }}
        >
          <h2 className="text-4xl font-semibold mb-16 text-center" style={{ fontSize: '40px' }}>Why DEEPFILM?</h2>
          ...
          <div style={{ 
            ...
            <div style={{ 
              ...
              <p style={{ 
                ...
                Get high-quality, cienmatic videos without– expensive equipment or production teams.
              </p>
            </div>
            ...
            <div style={{ 
              ...
              <div style={{
                ...
                <svg width="32" height="32" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <path d="M16 3.13C16.8604 3.3503 17.623 3.8507 18.1676 4.55231C18.7122 5.25392 19.0078 6.11683 19.0078 7.005C19.0078 7.89317 18.7122 8.75608 18.1676 9.45769C17.623 10.1593 16.8604 10.6597 16 10.88" stroke="black" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                </svg>
              </div>
              <h3 style={{ 
                fontSize: '28px',
        ...
        >
          ...
          <div className="space-y-8">
            ...
            <p className="text-2xl font-light leading-relaxed max-w-3xl mx-auto text-white/60">
