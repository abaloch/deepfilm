  ...
  return (
    <div className="min-h-screen bg-black text-white flex flex-col">
      ...
      <main className="container mx-auto px-4 mt-20">
        <h1 className="text-4xl md:text-3xl sm:text-xl leading-[1.1] font-medium tracking-tight max-w-4xl">Revolutionary AI face-swapping and de-aging tech for film. </h1>
